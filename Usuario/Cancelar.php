...
<body>
   ...
   //Aumentamos uno a las plazas disponibles
   ...
   echo mysqli_error($conexion);
   //Realizamos borrado en la tabla reservas
   $insercion="DELETE FROM reservas WHERE Nombre='$Nombre' AND Horario='$Horario' AND Profesor='$Profesor' AND Id_Usuario='$Id_Usuario' ";
