...
<head>
    ...
    <script>
        function leer(emisor,receptor,fecha,mensaje){
            window.location="http://localhost/VegaGym/Usuario/LeerMensaje.php?Emisor="+emisor+"&Receptor="+receptor+"&Fecha="+fecha+"&Mensaje="+mensaje;
        }
        function borrar(emisor,receptor,fecha,mensaje){
            window.location="http://localhost/VegaGym/Usuario/BorrarMensaje.php?Emisor="+emisor+"&Receptor="+receptor+"&Fecha="+fecha+"&Mensaje="+mensaje;
        }
    </script>
</head>
<?php
    ...
    <section class="row justify-content-center">
    	<article class="col-8">
            ...
            <form action="" method="post" enctype="multipart/form-data" style="margin: 15px" class="row justify-content-center">
            <table class="col-6">
                <tr>
                    <td colspan="4"><strong><?php echo $textos['EnviarMensaje'];?></strong></td>
                </tr>
