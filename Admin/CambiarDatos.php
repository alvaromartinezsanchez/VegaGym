...
?>
 <?php
                if(isset($_POST['Nombre'])&&isset($_POST['Apellido'])&&isset($_POST['Clave'])&&isset($_POST['Rol'])&&isset($_POST['Sexo'])&&isset($_POST['Edad'])){
                    //Obtenemos nuevos valores recividos de los campos y los almacenamos
...
<?php
    ...
    <section class="row justify-content-center">
    	<article class="col-8">
            ...
            <table width="400">
                <tr>
                    <td colspan="4"><?php echo $textos['DatosUsuario'];?></td>
                </tr>
                <tr>
                    <td><?php echo $textos['Id'];?></td> <td><input type="text" name="Id_Usuario" value=<?php echo $Id; ?> required readonly></td>
                    <td><?php echo $textos['Activo'];?></td> <td><input type="text" name="Activo" value=<?php echo $Activo; ?> required readonly></td>
                </tr>
                <tr>
