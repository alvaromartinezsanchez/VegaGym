		...
		<header class="row justify-content-center">
			...
			<div class="col-12">
				<div class="row justify-content-center">
		            ...
		            <a class="btn col" href="./NuevoUsuario.php"  role="button"><?php echo $textos['NuevoUsuario'];?></a></li>
					<a class="btn col" href="./ActivarUsuario.php" role="button"><?php echo $textos['ActivarUsuario'];?></a></li>
					<a class="btn col" href="./CrearClase.php" role="button"><?php echo $textos['CrearClase'];?></a></li>
